angular.module('suppletter.service', ['common.service', 'global_variable'])
	.service('suppletterService', function(global,$http) {
		return {
			initFlowPageData: function(id) {
				var url = global.SERVER_PATH + "/api/pendingTask/suppletter?id="+id;
				return $http({
					method: 'GET',
					url: url,
				});
