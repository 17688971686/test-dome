angular.module('annount.service', ['common.service', 'global_variable'])
	.service('annountService', function(global,$http) {
		return {
			initFlowPageData: function(id) {
				var url = global.SERVER_PATH + "/api/pendingTask/annount?id="+id;
				return $http({
					method: 'GET',
					url: url,
				});
