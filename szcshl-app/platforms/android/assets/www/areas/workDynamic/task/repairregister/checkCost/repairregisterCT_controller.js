angular.module('repairregisterCT.controller', ['common.service', 'ngCordova', 'angularBMap'])

	//待办工作列表控制器
	.controller('repairregisterCTCtrl', ["$scope", "$state", "repairregisterService", 'GlobalVariable', 'HttpUtil', 'fileSvc', 'Message',
