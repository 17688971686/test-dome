angular.module('repairregisterVB.controller', ['common.service', 'ngCordova', 'angularBMap'])

	//待办工作列表控制器
	.controller('repairregisterVBCtrl', ["$scope", "$state", "repairregisterService", 'GlobalVariable', 'HttpUtil', 'fileSvc', 'Message',
			...
			$scope.submitProc = function(){
				repairregisterService.update($scope, function() {
					var workJson = {
						...
						dealSuggestion: $scope.model.telVisitContent,
