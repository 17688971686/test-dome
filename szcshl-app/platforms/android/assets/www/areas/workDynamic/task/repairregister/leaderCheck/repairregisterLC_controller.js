angular.module('repairregisterLC.controller', ['common.service', 'ngCordova', 'angularBMap'])

	//待办工作列表控制器
	.controller('repairregisterLCCtrl', ["$scope", "$state", "repairregisterService", 'GlobalVariable', 'HttpUtil', 'fileSvc', 'Message',
