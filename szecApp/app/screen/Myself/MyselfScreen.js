            ...
            <View style={styles.container}>
                <View style={styles.header}>
                    ...
                    <View style={styles.userInfo}>
                        <Text style={{color:'#fff',fontSize:18,lineHeight:30}}>超级管理员</Text>
                        <Text style={{color:'#fff',fontSize:16}}>admin</Text>
                    </View>
                </View>
                <TouchableOpacity activeOpacity={0.8} style={styles.itemView} onPress={()=>navigation.navigate('BasicInfoScreen') }>
                    <Icon style={styles.itemIcon} color={'#15bc83'} name='ios-contact' size={28}/>
                    <Text style={styles.itemText}>账户基本信息</Text>
                </TouchableOpacity>
                <TouchableOpacity activeOpacity={0.8} style={styles.itemView} onPress={()=>navigation.navigate('SetUpScreen')}>
