...
/**
 * Description: 根据 user agent string 判断用户的平台、浏览器
 * 参考资料
 * **************************************************************************************************************************************************
 * <p>
 * 台式机
...
public final class UserAgentUtil {
    ...
    public static UserAgent getUserAgent(String userAgent) {
        ...
        if (userAgent.contains("Windows")) {
            ...
            if (userAgent.contains("Windows NT 10.0")) {
                //Windows 8
                return judgeClient(userAgent, "Windows", "10", null);
            } else if (userAgent.contains("Windows NT 6.2")) {
                //Windows 8
                return judgeClient(userAgent, "Windows", "8", null);
            } else if (userAgent.contains("Windows NT 6.1")) {
                //Windows 7
                return judgeClient(userAgent, "Windows", "7", null);
            } else if (userAgent.contains("Windows NT 6.0")) {
                //Windows Vista
                return judgeClient(userAgent, "Windows", "Vista", null);
            } else if (userAgent.contains("Windows NT 5.2")) {
                //Windows XP x64 Edition
                return judgeClient(userAgent, "Windows", "XP", "x64 Edition");
            } else if (userAgent.contains("Windows NT 5.1")) {
                //Windows XP
                return judgeClient(userAgent, "Windows", "XP", null);
            } else if (userAgent.contains("Windows NT 5.01")) {
                //Windows 2000, Service Pack 1 (SP1)
                return judgeClient(userAgent, "Windows", "2000", "SP1");
            } else if (userAgent.contains("Windows NT 5.0")) {
                //Windows 2000
                return judgeClient(userAgent, "Windows", "2000", null);
            } else if (userAgent.contains("Windows NT 4.0")) {
                //Microsoft Windows NT 4.0
                return judgeClient(userAgent, "Windows", "NT 4.0", null);
            } else if (userAgent.contains("Windows 98; Win 9x 4.90")) {
                //Windows Millennium Edition (Windows Me)
                return judgeClient(userAgent, "Windows", "ME", null);
            } else if (userAgent.contains("Windows 98")) {
                //Windows 98
                return judgeClient(userAgent, "Windows", "98", null);
            } else if (userAgent.contains("Windows 95")) {
                //Windows 95
                return judgeClient(userAgent, "Windows", "95", null);
            } else if (userAgent.contains("Windows CE")) {
                //Windows CE
                return judgeClient(userAgent, "Windows", "CE", null);
            } else {
                return judgeClient(userAgent, "Windows", null, null);
            }
            ...
            if (userAgent.contains("iPod")) {
                //判断浏览器
                return judgeClient(userAgent, "iPod", null, null);
            } else if (userAgent.contains("iPhone")) {
                //判断浏览器
                return judgeClient(userAgent, "iPhone", null, null);
            }
        } else if (userAgent.contains("Android")) {
            //判断浏览器
            return judgeClient(userAgent, "Android", null, null);
        } else if (userAgent.contains("Linux")) {
            //判断浏览器
            return judgeClient(userAgent, "Linux", null, null);
        }
        return new UserAgent();
    }
     ...
     * @return
     */
    private static UserAgent judgeClient(String userAgent, String platformType, String platformSeries, String platformVersion) {
        if(userAgent.contains("micromessenger")) {
            // 微信端
            return new UserAgent(ClientType.WECHAT, null, platformType, platformSeries, platformVersion);
        } else if (userAgent.contains("QQBrowser")) {
            // QQ浏览器
            //拿到User Agent String "Chrome/" 之后的字符串,结果形如"24.0.1295.0 Safari/537.15"或"24.0.1295.0"
            String temp = userAgent.substring(userAgent.indexOf("QQBrowser/") + 10);
            String qqVersion = null;
            //temp形如"24.0.1295.0"
            if (temp.indexOf(" ") < 0) {
                qqVersion = temp;
            } else {//temp形如"24.0.1295.0 Safari/537.15"
                qqVersion = temp.substring(0, temp.indexOf(" "));
            }
            return new UserAgent(ClientType.QQ, qqVersion, platformType, platformSeries, platformVersion);
            ...
            return new UserAgent(ClientType.CHROME, chromeVersion, platformType, platformSeries, platformVersion);
            ...
            return new UserAgent(ClientType.FIREFOX, ffVersion, platformType, platformSeries, platformVersion);
            ...
            if (userAgent.contains("MSIE 10.0")) {//Internet Explorer 10
                return new UserAgent(ClientType.IE, "10", platformType, platformSeries, platformVersion);
            } else if (userAgent.contains("MSIE 9.0")) {//Internet Explorer 9
                return new UserAgent(ClientType.IE, "9", platformType, platformSeries, platformVersion);
            } else if (userAgent.contains("MSIE 8.0")) {//Internet Explorer 8
                return new UserAgent(ClientType.IE, "8", platformType, platformSeries, platformVersion);
            } else if (userAgent.contains("MSIE 7.0")) {//Internet Explorer 7
                return new UserAgent(ClientType.IE, "7", platformType, platformSeries, platformVersion);
            } else if (userAgent.contains("MSIE 6.0")) {//Internet Explorer 6
                return new UserAgent(ClientType.IE, "6", platformType, platformSeries, platformVersion);
            } else {
                return new UserAgent(ClientType.IE, "6", platformType, platformSeries, platformVersion);
            }
            ...
            return new UserAgent(ClientType.SAFARI, safariVersion, platformType, platformSeries, platformVersion);
        } else if (userAgent.contains("OPERA")) {
            return new UserAgent(ClientType.OPERA, null, platformType, platformSeries, platformVersion);
        } else {//暂时支持以上三个主流.其它浏览器,待续...
            return new UserAgent(ClientType.OTHER, null, platformType, platformSeries, platformVersion);
        }
    }
}