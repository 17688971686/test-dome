...
(function (G, d, P) {
    ...
    d.module("ngAnimate", ["ng"]).directive("ngAnimateChildren", function () {
        ...
        var q = d.noop, w = d.forEach, Q = z.$$selectors, ba = 1, g = "$$ngAnimateState", ga = "$$ngAnimateChildren",
            I = "ng-animate", h = {running: !0};
            ...
            ["$window", "$sniffer", "$timeout", "$$animateReflow", function (g, h, z, J) {
                ...
                function W(a, b, c, d) {
                    ...
                    if (-1 != k.getAttribute("class").indexOf(c) && a) {
                        ...
                        var p = a.stagger, l = a.timings, q = a.itemIndex,
                ...
                var Q = "Duration", t = "Property", v = "Delay", n = "IterationCount", x = "$$ngAnimateKey",
                    u = "$$ngAnimateCSS3Data", S = "ng-animate-block-transitions", C = 3, D = 1.5, ca = 1E3, s = {},
                    da = 0, T = [], L, ea = null, fa = 0, Y = [];
                return {
                    enter: function (a, b) {
