(function () {
    ...
    assistCostCount.$inject = ['$location', 'assistCostCountSvc', '$state','$http' , 'expertReviewSvc' , 'bsWin'];

    function assistCostCount($location, assistCostCountSvc, $state,$http , expertReviewSvc , bsWin) {
