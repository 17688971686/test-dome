...
public class GoodsDetailController {
    ...
    @RequiresPermissions("goodsDetail#findByOData#post")
    ...
    @RequiresPermissions("goodsDetail##post")
    ...
    @RequiresPermissions("goodsDetail##delete")
    ...
    @RequiresPermissions("goodsDetail##put")
    ...
    // begin#html
    @RequiresPermissions("goodsDetail#html/list#get")
    @RequestMapping(name = "列表页面", path = "html/list", method = RequestMethod.GET)
    public String list() {
        return ctrlName+"/list"; 
    }

    @RequiresPermissions("goodsDetail#html/edit#get")
