...
public class FileLibraryController {
    ...
    @RequestMapping(name="质量管理文件库列表", path ="html/fileLibrary",method= RequestMethod.GET)
    public String list(){
    ...
    @RequestMapping(name="政策标准库—文件库列表",path="html/policyLibrary",method=RequestMethod.GET)
