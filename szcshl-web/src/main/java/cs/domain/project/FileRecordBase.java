 ...
 */
@MappedSuperclass
public class FileRecordBase extends DomainBase{
	...
	//报审登记表（中心报审登记表）是否有原件0表示没有，9表示有
	@Column(columnDefinition="VARCHAR(2)")
	private String recordFormOriginal;
	
	//报审登记表（中心报审登记表）是否有复印件
	@Column(columnDefinition="VARCHAR(2)")
	 ...
	 */
	@Column(columnDefinition="VARCHAR(2)")
	private String projectDataPrint;

	/**
	 * 项目沟通资料 份数
	 */
	@Column(columnDefinition="VARCHAR(2)")
	private String projectDataCount;

	/**
	 * 项目沟通资料 扫描
	 */
	@Column(columnDefinition="VARCHAR(2)")
	private String projectDataCountScan;

	//相关会议纪要是否有复印件
	@Column(columnDefinition="VARCHAR(2)")
	private String meetingSummaryCopy;

	//概算审核批复是否有复印件
	@Column(columnDefinition="VARCHAR(2)")
	private String budgetExamineCopy;
	...
	public String getProjectDataPrint() {
		return projectDataPrint;
	}

	public void setProjectDataPrint(String projectDataPrint) {
		this.projectDataPrint = projectDataPrint;
	}

	public String getProjectDataCount() {
		return projectDataCount;
	}

	public void setProjectDataCount(String projectDataCount) {
		this.projectDataCount = projectDataCount;
	}

	public String getProjectDataCountScan() {
		return projectDataCountScan;
	}

	public void setProjectDataCountScan(String projectDataCountScan) {
		this.projectDataCountScan = projectDataCountScan;
	}

	public String getMeetingSummaryCopy() {
		return meetingSummaryCopy;
	}

	public void setMeetingSummaryCopy(String meetingSummaryCopy) {
		this.meetingSummaryCopy = meetingSummaryCopy;
	}
